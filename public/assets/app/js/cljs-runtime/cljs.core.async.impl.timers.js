...
var i_42536 = (0);
while(true){
if((i_42536 < arr.length)){
(arr[i_42536] = null);

var G__42537 = (i_42536 + (1));
i_42536 = G__42537;
continue;
} else {
}
...
var i_42551 = (self__.level + (1));
while(true){
if((i_42551 <= (new_level + (1)))){
(update[i_42551] = self__.header);

var G__42553 = (i_42551 + (1));
i_42551 = G__42553;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_42564 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_42564[i]));
} else {
x__$2.forward.push((((i < links_42564.length))?(links_42564[i]):null));
}

if((i < links_42564.length)){
(links_42564[i] = x__$2);
} else {
links_42564.push(x__$2);
}
...
var i_42578 = (0);
while(true){
if((i_42578 <= self__.level)){
var links_42579 = (update[i_42578]).forward;
if((x__$1 === (((i_42578 < links_42579.length))?(links_42579[i_42578]):null))){
(links_42579[i_42578] = (x__$1.forward[i_42578]));

var G__42580 = (i_42578 + (1));
i_42578 = G__42580;
continue;
} else {
var G__42581 = (i_42578 + (1));
i_42578 = G__42581;
continue;
}
} else {
...
var G__42610 = nx;
var G__42611 = (level__$1 - (1));
x = G__42610;
level__$1 = G__42611;
continue;
} else {
var G__42613 = x;
var G__42614 = (level__$1 - (1));
x = G__42613;
level__$1 = G__42614;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__42635 = nx;
var G__42636 = (level__$1 - (1));
x = G__42635;
level__$1 = G__42636;
continue;
} else {
var G__42637 = x;
var G__42638 = (level__$1 - (1));
x = G__42637;
level__$1 = G__42638;
continue;
}
