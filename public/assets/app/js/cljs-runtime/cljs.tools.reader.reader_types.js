...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_40543 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_40543(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_40547 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_40547(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40548 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40548(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40552 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40552(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40553 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40553(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40559 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40559(reader);
}
});
...
var G__40650 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__40651 = s.append(c);
c = G__40650;
s = G__40651;
continue;
}
