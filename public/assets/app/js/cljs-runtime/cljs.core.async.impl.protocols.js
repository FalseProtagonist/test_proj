...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40452 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40452(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40456 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40456(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40460 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40460(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40465 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40465(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40466 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40466(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40470 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40470(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_40500 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_40500(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40508 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40508(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40509 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40509(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40511 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40511(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40512 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40512(b);
}
});
